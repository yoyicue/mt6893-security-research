...
| [13](13-apusys-ioctl-surface/) | APUSYS ioctl surface | `/dev/apusys` opens from `system_app`; provider opcode-0 dispatch is live, memory-create/VPU ucmd are mapped, and direct fd-source tests did not find a usable dmabuf fd. |
