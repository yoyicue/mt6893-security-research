...
2. APUSYS: recover Normal/Preload VPU algorithm keys and APUSYS command-buffer layout after the HardwareBuffer-backed `0x8001` and zero-header `run_cmd_async` parser gates.
