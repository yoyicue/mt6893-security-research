...
2. APUSYS: resolve the normal VPU `ucmd` `ENOENT` result after the HardwareBuffer-backed `0x8001` gate; identify the expected `payload+4` ABI and Normal/Preload algorithm lookup key.
